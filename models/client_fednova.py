...
class Client:
    ...
    def train_net_fednova(self,
        ...
        for epoch in range(epochs):
            ...
            # self.print_fn('Clients: %d Epoch: %d Loss: %f' % (self.idx, epoch, epoch_loss))
        # rho ？
        a_i = (tau - config.rho * (1 - pow(config.rho, tau)) / (1 - config.rho)) / (1 - config.rho)
