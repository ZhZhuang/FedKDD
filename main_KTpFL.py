...
from core_kt_pfl import kt_pfl_train
...
from utils import get_logger, cifar_noniid_dirichlet, cifar_noniid_byclass, fmnist_noniid_dirichlet, \
    fmnist_noniid_byclass, get_user_data, get_public_data
...
def init():
    ...
    parser.add_argument("--name", type=str, default="KTpFL", help="KTpFL | FedMD")
    ...
    # 数据增强
    parser.add_argument("--use_aug", type=str2bool,default=False, help="user data augment or not")
    # non-IID 参数
